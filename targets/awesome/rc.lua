...
vicious.register(clocktext, vw.date, " %Y.%m.%d <span color=\"#54ffc8\"><b>%H:%M:%S</b></span> ", 1)
...
vicious.register(kbtext, get_kb_layout, " $1", 32)

-- Battery
local battext = wibox.widget.textbox()
vicious.register(battext, vw.bat, " $1 $2% ($3)", 4, "BAT1")

-- Volume
local volumetext = wibox.widget.textbox()
vicious.register(volumetext, vw.volume, " $1", 33, "Master")
...
vicious.register(brighttext, get_brigthness, " $1", 30)
